    ...
    <div className=' text-2xl w-11/12 mx-auto flex flex-col gap-20 mb-20'>
      ...
      <div className=' w-10/12 mx-auto flex flex-col gap-4'>
        ...
        <div className='flex flex-col gap-3 xl:flex-row xl:w-7/12'>
          ...
          {!session?.user?<Link className='bg-white border-2 border-black w-full h-10 rounded-md text-black text-sm font-bold flex justify-center items-center' href={'/signin'}>Sign in</Link>:null}
        </div>
      </div>
    </div>
  )
